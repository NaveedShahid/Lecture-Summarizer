    ...
    def summarize_string(self, source_line, min_length=55, max_length=140):
        ...
        if self.hg_transformers:
            ...
            with torch.no_grad():
                ...
                hypotheses = self.bart.sample(source_line, beam=4, lenpen=2.0, max_len_a=0, max_len_b=max_length, min_length=min_length, no_repeat_ngram_size=3,truncation=True)
            return hypotheses[0]
