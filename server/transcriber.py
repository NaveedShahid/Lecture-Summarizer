...
def listen_print_loop(responses):
    ...
    print("Results can be found in {t} file after recording audio......".format(t=transcript_name))
    with open(transcript_name,"w+") as f:
        ...
        for response in responses:
            ...
            if not result.is_final:
                ...
                # one of our keywords.
                if re.search(r"\b(exit recording|quit recording)\b", transcript, re.I):
                    print("Exiting..")
                    f.writelines(lines)
                    f.close()
                    break
...
def record():
    ...
    print("Begin speaking now.......\nSay 'exit recording' or 'quit recording' to stop recording......\n")
